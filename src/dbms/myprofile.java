...
public class myprofile extends javax.swing.JFrame {
    ...
    private void dispimage()
    {
    	...
    	ResultSet r=s.executeQuery("select * from image where id='"+user+"'");
    	byte b[] = null;
    	while(r.next())
    	{
    	b= r.getBytes(2);
    ...
    private void initdisp()
    {
    	...
    	jTextField4.setText("MY PROFILE");
    	try {
    	...
    	try{
    		Connection c=getconnection(); 
    		Statement s=c.createStatement();
            ResultSet r=s.executeQuery("select name,domain_name,role,dob from users where username='"+user+"'");
            System.out.println(user);
            while(r.next())
            {   
    	...
    	try{
    		Connection c=getconnection(); 
    		Statement s=c.createStatement();
            ResultSet r=s.executeQuery("select domainid,specialization,address from details where username='"+user+"'");
            while(r.next())
            {   
    	...
    	try{
    		...
    		Connection c=getconnection(); 
    		Statement s=c.createStatement();
            ResultSet r=s.executeQuery("select qualification from qualifications where username='"+user+"'");
            while(r.next())
            {   
    	...
    	try{
    		...
    		Connection c=getconnection(); 
    		Statement s=c.createStatement();
            ResultSet r=s.executeQuery("select course from usercourses where username='"+user+"'");
            while(r.next())
            {   
